...
var VelocityContext = (function(){
	...
	function getData(){
		if(!data){
			...
			,{"name":"${context.javaBeanNameLF}","value":"Java类名且首字母小写","group":"${context}"}
			...
			,{"name":"${table.comment}","value":"表注释","group":"${table}"}
			...
			,{"name":"${column.comment}","value":"表字段注释","group":"#foreach($column in $columns)...#end"}
			]
		}
		return data;	
	}
