...
insert  into `datasource_config`(`dc_id`,`name`,`driver_class`,`jdbc_url`,`username`,`password`,`back_user`) values (2,'代码生成库','com.mysql.jdbc.Driver','jdbc:mysql://localhost:3306/auto_code','root','root','admin');
